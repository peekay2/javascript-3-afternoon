...
//Code Here
let evenNumbers = mixedNumbers.filter((nums, index, arr) => {
  return(nums % 2 === 0)
});
...
//Code Here
let totalPopulation = populations.reduce((runningTotal, currentNum, curIndex, arr)=>{
...
//Code Here
let myStrongest = monstersInYourPocket.filter((pokemon, index, wholeArray)=>{
